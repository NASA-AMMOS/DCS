...
int main(int argc, char **argv)
{
    ...
    sdls_config_cryptolib_tc(create_fecf, process_sdls_pdus, has_pus_hdr, ignore_anti_replay, ignore_sa_state, unique_sa_per_mapid, check_fecf, vcid_bitmask, increment_nontransmitted_iv);
    ...
    sdls_config_add_gvcid_managed_parameter_tc(tfvn, scid, vcid, has_fecf, has_segmentation_hdr, max_tc_frame_size);
